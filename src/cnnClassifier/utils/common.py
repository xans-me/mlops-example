...
def create_directories(path_to_directories: list, verbose=True):
    ...
    Args:
        ...
        ignore_log (bool, optional): ignore if multiple directories created. Defaults to True.
    """
...
def load_json(path: Path) -> ConfigBox:
    ...
    Returns:
        ConfigBox: data as class atrributes instead of dictionary
    """
    with open(path) as f:
        data = json.load(f)
